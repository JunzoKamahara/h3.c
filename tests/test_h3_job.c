...
int main(void) {
    ...
    h3_job_request a = {H3_JOB_VIDEO, "clip a", 1, 256, 256, 25, NULL};
    h3_job_request b = {H3_JOB_VIDEO, "clip b", 2, 256, 256, 25, NULL};
    h3_job_request c = {H3_JOB_VIDEO, "clip c", 0xDEAD, 256, 256, 25, NULL};
